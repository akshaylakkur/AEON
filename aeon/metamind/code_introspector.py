"""AST-based code introspection for the aeon/ tree."""
...
from aeon.metamind.dataclasses import ClassInfo, FunctionInfo, ModuleInfo, SourceMap
...
class CodeIntrospector:
    """AST-based analysis of the aeon/ tree."""
    ...
    def build_source_map(self, package: str = "aeon") -> SourceMap:
    ...
    def find_callers(self, target: str, package: str = "aeon") -> list[CallerInfo]:
