...
from aeon.metamind.dependency_manager import DependencyManager, DependencyReport
from aeon.metamind.evolution_gate import EvolutionGate
from aeon.metamind.module_generator import GeneratedCode, ModuleGenerator, ModuleSpecification
from aeon.metamind.patch_applier import CodePatch, PatchApplier, PatchResult
from aeon.metamind.rollback_journal import RollbackJournal
...
class SelfModificationEngine:
    ...
    def __init__(
        ...
        self.generator = ModuleGenerator(
            llm=llm,
            template_dir=self.project_root / "aeon" / "metamind" / "templates",
    ...
    async def generate_module(
        ...
        try:
            ...
            target_path = spec.target_path or (
                self.project_root / "aeon" / f"{spec.module_name}.py"
            )
    ...
    async def introspect_module(self, module_path: str) -> ModuleInfo:
        """Return structured metadata about any module in aeon/."""
    ...
    def find_callers(self, target: str, package: str = "aeon") -> list:
    ...
    async def _check_hibernation_advisory(self) -> None:
        ...
        if len(self._failures) > self._failure_threshold:
            ...
            if self.state_machine is not None:
                await self.state_machine.transition_to(State.SLEEPING)
