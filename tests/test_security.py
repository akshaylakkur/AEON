"""Comprehensive pytest suite for aeon/security."""
...
from aeon.security.exceptions import (
    ApprovalRequired,
    AuditError,
    BudgetExceeded,
...
from aeon.security.config import NetworkRule, SecurityConfig, SpendGuardConfig
from aeon.security.coordinator import SecureExecutionEnvironment
from aeon.security.file_sandbox import FileSandbox
from aeon.security.network_gate import NetworkGate
from aeon.security.risk_coordinator import (
    PendingDecision,
    RiskCoordinator,
    RiskLevel,
    RiskReview,
...
class TestRiskCoordinator:
    ...
    def _coord_env(self, tmp_path):
        ...
        from aeon.security.spend_caps import SpendGuard
