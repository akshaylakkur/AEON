...
from aeon.security.config import NetworkRule, ResourceLimits, SecurityConfig, SpendGuardConfig
...
class TestFileSandbox:
    ...
    def test_read_denied_immutable(self):
        with pytest.raises(FileAccessDenied):
            self.fs.read("aeon/terminal.py", module="test")
    ...
    def test_write_denied_immutable(self):
        with pytest.raises(FileAccessDenied):
            self.fs.write("aeon/terminal.py", b"data", module="test")
    ...
    def test_listdir_denied_immutable(self):
        with pytest.raises(FileAccessDenied):
            self.fs.listdir("aeon/core/", module="test")
