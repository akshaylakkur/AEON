"""Comprehensive pytest suite for aeon.limbs.web_automation."""
...
from aeon.limbs.web_automation.captcha_solver import CaptchaSolver, CaptchaSolution
...
async def test_browser_controller_start_stop(mock_playwright, mock_browser):
    ...
    with patch("aeon.limbs.web_automation.browser_controller.async_playwright") as mock_pw_factory:
